...
<section id="hero" class="flex flex-1 items-center py-16">
    <img
        src="{{ $background }}"
        alt=""
        class="absolute inset-0 -z-10 size-full object-cover object-right dark:hidden lg:object-center">
    <img
        src="{{ $darkBackground }}"
        alt=""
        class="absolute inset-0 -z-10 hidden size-full object-cover object-right dark:block lg:object-center">
    ...
    <div class="mx-auto w-full max-w-7xl px-6 lg:px-8">
        <p class="inline-flex items-center gap-1.5 rounded-full bg-card/30 px-3 py-1.5 text-base text-muted ring-1 ring-card/90 sm:text-sm">
